...
import { Button, Form, ArrowList } from 'components/ui'
  ...
  return (
    ...
    <InlineGithubForm form={form}>
      <Layout>
        ...
        <InlineField name="">
          {({ input }) => {
            return <Form src={input.value} autoPlay={cms.disabled} />
          }}
        </InlineField>
<br/><br/><br/><br/>   
{/* the hero is overlaping the top..
        <InlineField name="">
          {({ input }) => {
            return <Game src={input.value} autoPlay={cms.disabled} />
          }}
        </InlineField>
 <br/><br/><br/><br/>  
        <InlineField name="">
