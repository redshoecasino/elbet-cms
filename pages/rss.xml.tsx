...
const blogPostsRssXml = async blogPosts => {
  ...
  for (let post of blogPosts) {
    ...
    rssItemsXml += `<item>
      ...
      <link>https://www.redshoecasino.com/blog/${post.data.slug}</link>
...
const getRssXml = async blogPosts => {
  ...
  <rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>El Bet Blog RSS Feed</title>
      <link>https://www.redshoecasino.com/</link>
      <description>A pirate casino for rouges</description>
