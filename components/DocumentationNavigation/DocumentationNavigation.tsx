...
import { ElBetIcon } from 'components/logo/ElBetIcon'
...
const MobileNavLogo = styled(ElBetIcon)`
  position: relative;
  display: block;
  padding: 1rem 0;
...
const DocsDesktopElBetIcon = styled(ElBetIcon)`
  position: relative;
  display: none;
  margin-bottom: 1rem;
